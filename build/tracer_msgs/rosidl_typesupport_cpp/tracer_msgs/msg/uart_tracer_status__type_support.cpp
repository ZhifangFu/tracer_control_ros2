...
static const _UartTracerStatus_type_support_symbol_names_t _UartTracerStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tracer_msgs, msg, UartTracerStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tracer_msgs, msg, UartTracerStatus)),
  }
};
...
{
  return &::tracer_msgs::msg::rosidl_typesupport_cpp::UartTracerStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tracer_msgs, msg, UartTracerStatus)() {
  return get_message_type_support_handle<tracer_msgs::msg::UartTracerStatus>();
}
