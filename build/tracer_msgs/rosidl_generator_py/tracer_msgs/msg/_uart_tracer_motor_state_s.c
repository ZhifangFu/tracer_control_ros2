...
bool tracer_msgs__msg__uart_tracer_motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tracer_msgs.msg._uart_tracer_motor_state.UartTracerMotorState", full_classname_dest, 61) == 0);
  }
  tracer_msgs__msg__UartTracerMotorState * ros_message = _ros_message;
  {  // current
...
{
  /* NOTE(esteve): Call constructor of UartTracerMotorState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tracer_msgs.msg._uart_tracer_motor_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UartTracerMotorState");
