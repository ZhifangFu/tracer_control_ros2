...
class TracerLightCmd(metaclass=Metaclass_TracerLightCmd):
    ...
    _fields_and_field_types = {
        'enable_cmd_light_control': 'boolean',
        'front_mode': 'uint8',
    ...
    def __init__(self, **kwargs):
        ...
        self.enable_cmd_light_control = kwargs.get('enable_cmd_light_control', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.enable_cmd_light_control != other.enable_cmd_light_control:
            return False
    ...
    @builtins.property
    def enable_cmd_light_control(self):
        """Message field 'enable_cmd_light_control'."""
        return self._enable_cmd_light_control

    @enable_cmd_light_control.setter
    def enable_cmd_light_control(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'enable_cmd_light_control' field must be of type 'bool'"
        self._enable_cmd_light_control = value
