...
class Metaclass_TracerStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tracer_msgs.msg import TracerMotorState
            if TracerMotorState.__class__._TYPE_SUPPORT is None:
                TracerMotorState.__class__.__import_type_support__()
...
class TracerStatus(metaclass=Metaclass_TracerStatus):
    ...
    _fields_and_field_types = {
        ...
        'motor_states': 'tracer_msgs/TracerMotorState[2]',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['tracer_msgs', 'msg'], 'TracerMotorState'), 2),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_states = kwargs.get(
            'motor_states',
            [TracerMotorState() for x in range(2)]
        )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) == 2 and
                 all(isinstance(v, TracerMotorState) for v in value) and
                 True), \
                "The 'motor_states' field must be a set or sequence with length 2 and each value of type 'TracerMotorState'"
