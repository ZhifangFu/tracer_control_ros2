...
#include "tracer_msgs/msg/detail/tracer_motor_state__functions.h"  // motor_states
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: motor_states
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, tracer_msgs, msg, TracerMotorState
      )()->data);
    size_t size = 2;
  ...
  size_t current_alignment)
{
  ...
  // field.name motor_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_tracer_msgs__msg__TracerMotorState(
  ...
  size_t current_alignment)
{
  ...
  // member: motor_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_tracer_msgs__msg__TracerMotorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
