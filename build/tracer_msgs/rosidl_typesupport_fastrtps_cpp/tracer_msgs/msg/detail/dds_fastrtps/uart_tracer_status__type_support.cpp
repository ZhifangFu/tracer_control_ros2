...
#include "tracer_msgs/msg/detail/uart_tracer_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tracer_msgs::msg::UartTracerMotorState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  tracer_msgs::msg::UartTracerMotorState &);
size_t get_serialized_size(
  const tracer_msgs::msg::UartTracerMotorState &,
  size_t current_alignment);
size_t
...
// functions for tracer_msgs::msg::TracerLightState already declared above
...
cdr_serialize(
  const tracer_msgs::msg::UartTracerStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tracer_msgs::msg::UartTracerStatus & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tracer_msgs
max_serialized_size_UartTracerStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: motor_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tracer_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_UartTracerMotorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = tracer_msgs::msg::UartTracerStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tracer_msgs::msg::UartTracerStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tracer_msgs::msg::UartTracerStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UartTracerStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tracer_msgs::msg::UartTracerStatus *>(
...
static size_t _UartTracerStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UartTracerStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UartTracerStatus__callbacks = {
  "tracer_msgs::msg",
  "UartTracerStatus",
...
static rosidl_message_type_support_t _UartTracerStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UartTracerStatus__callbacks,
...
{
  return &tracer_msgs::msg::typesupport_fastrtps_cpp::_UartTracerStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tracer_msgs, msg, UartTracerStatus)() {
  return &tracer_msgs::msg::typesupport_fastrtps_cpp::_UartTracerStatus__handle;
}
