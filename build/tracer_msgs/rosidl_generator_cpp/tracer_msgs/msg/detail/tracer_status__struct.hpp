...
struct TracerStatus_
{
    ...
    front_light_state(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->motor_states.fill(tracer_msgs::msg::TracerMotorState_<ContainerAllocator>{_init});
    ...
    front_light_state(_alloc, _init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->fault_code = 0;
      this->battery_voltage = 0.0;
      this->motor_states.fill(tracer_msgs::msg::TracerMotorState_<ContainerAllocator>{_alloc, _init});
      this->light_control_enabled = false;
      this->left_odomter = 0.0;
      this->right_odomter = 0.0;
    }
  ...
  using _motor_states_type =
    std::array<tracer_msgs::msg::TracerMotorState_<ContainerAllocator>, 2>;
  ...
  Type & set__motor_states(
    const std::array<tracer_msgs::msg::TracerMotorState_<ContainerAllocator>, 2> & _arg)
  {
