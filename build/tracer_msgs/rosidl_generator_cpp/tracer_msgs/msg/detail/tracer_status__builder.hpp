...
class Init_TracerStatus_motor_states
{
public:
  explicit Init_TracerStatus_motor_states(::tracer_msgs::msg::TracerStatus & msg)
  : msg_(msg)
  {}
  Init_TracerStatus_light_control_enabled motor_states(::tracer_msgs::msg::TracerStatus::_motor_states_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_TracerStatus_motor_states battery_voltage(::tracer_msgs::msg::TracerStatus::_battery_voltage_type arg)
  {
    msg_.battery_voltage = std::move(arg);
    return Init_TracerStatus_motor_states(msg_);
  }
...
class Init_TracerStatus_fault_code
{
public:
  explicit Init_TracerStatus_fault_code(::tracer_msgs::msg::TracerStatus & msg)
  : msg_(msg)
  {}
  Init_TracerStatus_battery_voltage fault_code(::tracer_msgs::msg::TracerStatus::_fault_code_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_TracerStatus_fault_code control_mode(::tracer_msgs::msg::TracerStatus::_control_mode_type arg)
  {
    msg_.control_mode = std::move(arg);
    return Init_TracerStatus_fault_code(msg_);
  }
...
class Init_TracerStatus_base_state
{
public:
  explicit Init_TracerStatus_base_state(::tracer_msgs::msg::TracerStatus & msg)
  : msg_(msg)
  {}
  Init_TracerStatus_control_mode base_state(::tracer_msgs::msg::TracerStatus::_base_state_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_TracerStatus_base_state angular_velocity(::tracer_msgs::msg::TracerStatus::_angular_velocity_type arg)
  {
    msg_.angular_velocity = std::move(arg);
    return Init_TracerStatus_base_state(msg_);
  }
