...
class Init_TracerLightCmd_enable_cmd_light_control
{
public:
  Init_TracerLightCmd_enable_cmd_light_control()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TracerLightCmd_front_mode enable_cmd_light_control(::tracer_msgs::msg::TracerLightCmd::_enable_cmd_light_control_type arg)
  {
    msg_.enable_cmd_light_control = std::move(arg);
...
{
  return tracer_msgs::msg::builder::Init_TracerLightCmd_enable_cmd_light_control();
}
