...
: ${AMENT_CURRENT_PREFIX:="/root/tracer_control_ws/install/tracer_base"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tracer_base/environment/library_path.sh"
